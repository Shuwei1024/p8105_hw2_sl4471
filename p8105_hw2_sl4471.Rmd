...
The "wheel_df" tells us different kinds of rubbish in dumsters from year 2014-2018. It contains `r nrow(wheel_df)` observations with `r ncol(wheel_df)` variables. The key variable here is "dumpster".

The "precipitation_df" tells us different kinds of rubbish in dumsters from year 2014-2018. It contains `r nrow(precipitation_df)` observations with `r ncol(precipitation_df)` variables. The key variable here is "year".
